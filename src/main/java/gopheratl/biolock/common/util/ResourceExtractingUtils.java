package gopheratl.biolock.common.util;
...
public class ResourceExtractingUtils {
	...
	public static void extractZipToLocation(File zipFile, String sourceFolder,
		...
		try {
			...
			File destFile = new File(BioLock.proxy.getBase(), destFolder);
			...
			BLLog.warn("Error while extracting Lua files. Peripheral may not automount Lua files! Exception follows.");
			e.printStackTrace();
		}
	}
